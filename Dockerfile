...
RUN echo "no" | avdmanager create avd -n first_avd --abi google_apis/x86 -k "system-images;android-28;google_apis;x86"

RUN echo "no" | avdmanager create avd -n second_avd --abi google_apis/x86 -k "system-images;android-28;google_apis;x86"
